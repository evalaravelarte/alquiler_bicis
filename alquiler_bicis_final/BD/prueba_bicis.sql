...
-- -----------------------------------------------------
-- Data for table `alquiler_bicis_final`.`bici`
-- -----------------------------------------------------
START TRANSACTION;
USE `alquiler_bicis_final`;
INSERT INTO `alquiler_bicis_final`.`bici` (`cod_bici`, `libre`, `hora_alquiler`, `hora_devolucion`) VALUES (1, 0, NULL, NULL);
INSERT INTO `alquiler_bicis_final`.`bici` (`cod_bici`, `libre`, `hora_alquiler`, `hora_devolucion`) VALUES (2, 0, NULL, NULL);

COMMIT;


-- -----------------------------------------------------
-- Data for table `alquiler_bicis_final`.`usuario`
-- -----------------------------------------------------
START TRANSACTION;
USE `alquiler_bicis_final`;
INSERT INTO `alquiler_bicis_final`.`usuario` (`cod_usuario`, `nombre`, `cod_bici`) VALUES (1, 'Eva', NULL);
INSERT INTO `alquiler_bicis_final`.`usuario` (`cod_usuario`, `nombre`, `cod_bici`) VALUES (2, 'Juan', NULL);
